                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button
                                                ...
                                                data-toggle="modal"
                                                data-target="#{{$message->id}}ModalDeleteProfessor">
                                            <i class="fa fa-trash"></i>
                                        </button>
                                        <div class="modal fade" id="{{$message->id}}ModalDeleteProfessor"
                                            ...
                                            <div class="modal-dialog" role="document">a
                                                <div class="modal-content">
                                                    ...
                                                    {!! BootForm::openHorizontal($columnSizes)->action(route('deleteMessageProfessor')) !!}
